...
class GetAllCharactersUseCaseTest {
    ...
    fun setup() {
        ...
        getAllCharactersUseCase =
            GetAllCharactersUseCase { isRefreshing ->
                getAllCharacters(isRefreshing, charactersRepository)
            }
    }

    @Test
    fun `when repository returns success then use case returns success`() =
        runTest {
            // Given
    ...
    @Test
    fun `when repository returns failure then use case returns failure`() =
        runTest {
            // Given
    ...
    @Test
    fun `when isRefreshing is true then repository is called with true`() =
        runTest {
            // Given
